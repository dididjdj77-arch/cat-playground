...
export async function readSessionState(client: SupabaseClient): Promise<AuthActionResult> {
...
export async function clearSession(client: SupabaseClient): Promise<AuthActionResult> {
