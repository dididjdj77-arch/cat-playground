...
## 전역: 작성자(닉네임/아바타) 탭 액션 메뉴
- 적용: 소셜 영역의 작성자 표기(냥스타 피드/상세/댓글, 채널 스레드/상세/답글 등)에서 동일 동작
- 메뉴 항목(LOCK): 고양이정보 / 하우스 보기 / 냥스타그램 (D-017)
- 하우스 보기 → `/u/{nickname}/house` (v1 공개 하우스 도달 경로, D-099)
...
- 작성자(닉네임/아바타) 탭: 전역 액션 메뉴 규칙 적용(D-017, D-099)
...
- Entry(v1): 작성자(닉네임/아바타) 탭 액션 메뉴 → 하우스 보기 (D-099)
