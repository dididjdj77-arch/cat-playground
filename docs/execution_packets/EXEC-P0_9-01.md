# Execution Packet — P0.9-01: Expo 최소 앱: 로그인 → 세션 확인 → auth-only RPC 1회 호출

> Issued: 2026-02-17 (Asia/Seoul)  
> Phase ref: `PHASE-0.9.md` / EP `P0.9-01`  
...
## SSOT read first
- `PHASE-0.9.md` (Phase skeleton)
- `docs/PROCESS.md`
- `docs/DECISIONS.md`
- `docs/API.md`
- `docs/VERIFICATION.md`
- `docs/playbooks/ops-app-config.md`
- `docs/DECISIONS.md` (관련 Decision: D-056, D-066)
...
### 4) App(Expo) 구현
> 이 EP는 auth spike이므로 Transport Adapter(P2-00)는 아직 존재하지 않는다. 최소한의 직접 호출로 검증한다.
...
```markdown
# Result Packet — P0.9-01: Expo 최소 앱: 로그인 → 세션 확인 → auth-only RPC 1회 호출
