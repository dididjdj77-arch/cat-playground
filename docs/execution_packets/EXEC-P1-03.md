# Execution Packet — P1-03: 하우스 RPC: 슬롯 bind/clear + house_profile lazy create + 공개 슬롯 요약(auth-only)

> Issued: 2026-02-17 (Asia/Seoul)  
> Phase ref: `PHASE-1.md` / EP `P1-03`  
...
- `docs/playbooks/rpc-public.md`
- `docs/DECISIONS.md` (관련 Decision: D-035, D-037, D-043, D-050, D-055, D-074)
...
```markdown
# Result Packet — P1-03: 하우스 RPC: 슬롯 bind/clear + house_profile lazy create + 공개 슬롯 요약(auth-only)
