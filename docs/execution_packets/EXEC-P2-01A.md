# Execution Packet — P2-01A: 로그인/로그아웃 + 세션 생성/저장/복구(실기기)

> Issued: 2026-02-17 (Asia/Seoul)  
> Phase ref: `PHASE-2.md` / EP `P2-01A`  
...
- `docs/DECISIONS.md` (관련 Decision: D-066)
...
- DB schema/RPC/RLS/GRANT/REVOKE 변경 — Impact flags 전부 no. 이 EP는 앱 로그인/세션 구현만 다룬다.
...
```markdown
# Result Packet — P2-01A: 로그인/로그아웃 + 세션 생성/저장/복구(실기기)
