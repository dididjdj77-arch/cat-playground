# Execution Packet — P2-02: 하우스 플로우 번들

> Issued: 2026-02-17 (Asia/Seoul)  
> Phase ref: `PHASE-2.md` / EP `P2-02`  
...
- `docs/DECISIONS.md` (관련 Decision: D-006, D-035, D-037, D-074, D-099)
...
- DB schema/RPC/RLS/GRANT/REVOKE 변경 — Impact flags 전부 no. 이 EP는 앱 하우스 UI 구현만 다룬다.
...
```markdown
# Result Packet — P2-02: 하우스 플로우 번들
